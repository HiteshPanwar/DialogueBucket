...
import com.dialogueapp.dialoguebucket.dialoguesharingapp.categories.Exclusive;
...
/**   RecyclerAdapterExclusive
 * Created by HITESH on 9/6/2017.*/

public class RecyclerAdapterExclusive extends RecyclerView.Adapter<RecyclerAdapterExclusive.MyHolder> implements Filterable {
    ...
    public RecyclerAdapterExclusive(List<Category> listdata,Context context  ) {
    ...
    class MyHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void setListeners() {
            imageView.setOnClickListener(RecyclerAdapterExclusive.MyHolder.this);
            cname.setOnClickListener(RecyclerAdapterExclusive.MyHolder.this);
        }
            ...
            switch (view.getId()) {
                case R.id.category_poster:
                    ...
                    // Toast.makeText(view.getContext(),"Loading...",Toast.LENGTH_SHORT).show();
                        ...
                        Intent intent = new Intent(context,Exclusive.class);
...
*/
                ...
                case R.id.category_name:
                    ...
                    // Toast.makeText(view.getContext(),"Loading...",Toast.LENGTH_SHORT).show();
                         ...
                         link = data.getCategoryLinker();

                         intent = new Intent(context,Exclusive.class);
                        intent.putExtra("key",link);
                        intent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
                        view.getContext().startActivity(intent);
