...
public class Haryanvi extends AppCompatActivity {
    List<Dialogue> list;
    String link;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_browse_audio_haryanvi);
...
//get the value based on the key
        ...
        mDatabaseReference=  database.getReference("AUDIO").child("BROWSE").child("HARYANVI").child(link);
