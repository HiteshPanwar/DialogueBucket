...
public class HollywoodActors extends AppCompatActivity {
    List<Dialogue> list;
    String link;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_browse_audio_hollywoodactors);
...
//get the value based on the key
        ...
        mDatabaseReference=  database.getReference("AUDIO").child("BROWSE").child("HOLLYWOOD").child("ACTORS").child(link);
