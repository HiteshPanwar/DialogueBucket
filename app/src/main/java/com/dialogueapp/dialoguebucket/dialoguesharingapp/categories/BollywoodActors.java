...
public class BollywoodActors extends AppCompatActivity {
    List<Dialogue> list;
    String link;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_browse_audio_bollywoodactors);
...
//get the value based on the key
        ...
        mDatabaseReference=  database.getReference("AUDIO").child("BROWSE").child("BOLLYWOOD").child("ACTORS").child(link);
